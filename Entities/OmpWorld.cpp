...
OmpWorld::OmpWorld(sf::Vector2<double> size): World(size){}

void OmpWorld::merge(int bigger, int smaller) {
...
void OmpWorld::collision(int i, int j, sf::Vector2<double> tang) {
...
void OmpWorld::Tick(double elapsedSec) {
